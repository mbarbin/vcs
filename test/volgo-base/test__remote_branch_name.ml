...
let%expect_test "hash" =
  ...
  [%expect
    ...
    (((value ((remote_name origin) (branch_name main))) (seed 42))
     ((stdlib_hash 1032210503) (vcs_hash 1032210503) (vcs_base_hash 701314591)))
    ...
    (((value ((remote_name upstream) (branch_name my-branch))) (seed 0))
     ((stdlib_hash 925005510) (vcs_hash 925005510) (vcs_base_hash 470939564)))
    (((value ((remote_name upstream) (branch_name my-branch))) (seed 42))
