  ...
  [%expect
    ...
    (((
       value (
         ...
         (user_handle jdoe)
         (repo_name   vcs))))
     ((stdlib_hash   722289376)
      (vcs_hash      722289376)
      (vcs_base_hash 31940564)))
    (((value (
        (platform    GitHub)
        (vcs_kind    Git)
        (user_handle jdoe)
    ...
    (((value (
        ...
        (repo_name   vcs)))
      (seed 42))
     ((stdlib_hash   255089139)
      (vcs_hash      255089139)
      (vcs_base_hash 46231834)))
    (((
       value (
         (platform    Codeberg)
         (vcs_kind    Hg)
    ...
    (((value (
        ...
        (repo_name   vcs)))
      (seed 42))
     ((stdlib_hash   275801981)
      (vcs_hash      275801981)
      (vcs_base_hash 818163617)))
    |}];
  ()
;;
  ...
  [%expect
    ...
    (((
       value (
         ...
         (repo_name   vcs)
         (protocol    Https))))
     ((stdlib_hash   710011599)
      (vcs_hash      710011599)
      (vcs_base_hash 329544140)))
    (((value (
        (platform    GitHub)
        (vcs_kind    Git)
        (user_handle jdoe)
    ...
    (((value (
        ...
        (protocol    Https)))
      (seed 42))
     ((stdlib_hash   429507035)
      (vcs_hash      429507035)
      (vcs_base_hash 923827283)))
    (((
       value (
         (platform    GitHub)
         (vcs_kind    Git)
         ...
         (repo_name   vcs)
         (protocol    Ssh))))
     ((stdlib_hash   615184651)
      (vcs_hash      615184651)
      (vcs_base_hash 252115316)))
    (((value (
        (platform    GitHub)
        (vcs_kind    Git)
        (user_handle jdoe)
    ...
    (((value (
        ...
        (protocol    Ssh)))
      (seed 42))
     ((stdlib_hash   478271362)
      (vcs_hash      478271362)
      (vcs_base_hash 717526480)))
    (((
       value (
         (platform    Codeberg)
         (vcs_kind    Hg)
         ...
         (repo_name   vcs)
         (protocol    Https))))
     ((stdlib_hash   132313437)
      (vcs_hash      132313437)
      (vcs_base_hash 864452121)))
    (((value (
        (platform    Codeberg)
        (vcs_kind    Hg)
        (user_handle jdoe)
    ...
    (((value (
        ...
        (protocol    Https)))
      (seed 42))
     ((stdlib_hash   674853689)
      (vcs_hash      674853689)
      (vcs_base_hash 512522645)))
    (((
       value (
         (platform    Codeberg)
         (vcs_kind    Hg)
         ...
         (repo_name   vcs)
         (protocol    Ssh))))
     ((stdlib_hash   706171373)
      (vcs_hash      706171373)
      (vcs_base_hash 319303260)))
    (((value (
        (platform    Codeberg)
        (vcs_kind    Hg)
        (user_handle jdoe)
    ...
    (((value (
        ...
        (protocol    Ssh)))
      (seed 42))
     ((stdlib_hash   543520998)
      (vcs_hash      543520998)
      (vcs_base_hash 90942002)))
    |}];
  ()
;;
