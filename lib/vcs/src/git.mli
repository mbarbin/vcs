...
(** This is the interface commonly used by raising and non-raising helper
    modules, such as {!module:Vcs.Git}, {!module:Vcs_base.Vcs.Git.Or_error},
...
module Non_raising : sig
  (** A functor to build non raising helpers based on a custom error type.
      ...
      {!module:Vcs_base.Vcs.Git.Or_error}, we provide this functor to create a
      [Git.S] interface based on a custom error type of your choice. *)
